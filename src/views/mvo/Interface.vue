<template>
  ...
  <div class="app-container">
    ...
    <el-button type="success" @click="withdrawalSubsidiary">提现明细</el-button>
    ...
    >
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="text" @click="withDraw" size="small">提现</el-button>
        </template>
      </el-table-column>
...
<!--    提现-->
    ...
    <el-dialog title="提现" :modal="false" top="390px" :visible.sync="dialogAddVisible" width="20%" >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="withDrawAccount">确 定</el-button>
      </div>
    </el-dialog>
    </div>
  </div>
